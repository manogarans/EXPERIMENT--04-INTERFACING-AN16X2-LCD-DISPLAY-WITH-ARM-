...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Manogaran S\n");
	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212223240081");
...
![WhatsApp Image 2024-11-11 at 22 44 09_6702d04b](https://github.com/user-attachments/assets/8299edbc-4ed2-4e0f-8266-be0098a25ea1)
